...
public class TicketPageController implements Initializable {
    ...
    public void setData(Reservation reservation, List<Seat> selectedSeats) {
        ...
        for(Seat selectedSeat: selectedSeats) {
                seats += "  " + selectedSeat.getColumn() + selectedSeat.getRow() + "        " + selectedSeat.getPassengerName() + "\n";
            classType += selectedSeat.getType() + " class" + "\n";
            lblSelectedSeat.setText(seats);
            lblClassType.setText(classType );
        }
